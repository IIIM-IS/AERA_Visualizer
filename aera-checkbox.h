...
#ifndef AERA_VISUALIZER_AERA_CHECKBOX_HPP
#define AERA_VISUALIZER_AERA_CHECKBOX_HPP
...
namespace aera_visualizer {
  ...
  class AeraCheckbox : public QCheckBox {
      Q_OBJECT

  public:
      AeraCheckbox(QString text, QString settingsKey, QWidget *parent, Qt::CheckState defaultCheckedState = Qt::Unchecked);

      void setColor(QColor color);

  private:
      static const QColor CheckboxDefaultColor;

      void persistState(int state);
      void setupInitialState(Qt::CheckState defaultCheckedState);
...
#endif //AERA_VISUALIZER_AERA_CHECKBOX_HPP