...
#ifndef ANCHORED_HORIZONTAL_LINE_HPP
#define ANCHORED_HORIZONTAL_LINE_HPP
...
/**
 * An AnchoredHorizontalLine extends QGraphicsLineItem to draw a horizontal line with vertical bars at
 * the left and right end which moves up and down with the item, but keeps the same horizontal extent.
 */
class AnchoredHorizontalLine : public QGraphicsLineItem
{
public:
...
private:
  ...
  static const int verticalBarRadius_ = 10;
  QGraphicsPolygonItem* item_;
  qreal left_;
  qreal right_;
  QPolygonF leftVerticalBar_;
  QPolygonF rightVerticalBar_;
};
