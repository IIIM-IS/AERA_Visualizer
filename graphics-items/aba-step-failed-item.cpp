...
#include "aba-step-failed-item.hpp"
...
AbaStepFailedItem::AbaStepFailedItem(
  AbaStepFailedEvent* stepFailedEvent, ReplicodeObjects& replicodeObjects,
  AeraVisualizerScene* parent)
: AeraGraphicsItem(stepFailedEvent, replicodeObjects, parent, ""),
  stepFailedEvent_(stepFailedEvent)
{
...
void AbaStepFailedItem::setMessageHtml()
{
  expandedMessageHtml_ = "Step " + QString::number(stepFailedEvent_->step_) + " failed";
  QString messageHtml = "fail";
...
void AbaStepFailedItem::textItemLinkActivated(const QString& link)
{
  if (link == "#expand") {
