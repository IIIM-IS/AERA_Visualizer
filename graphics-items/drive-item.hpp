...
#ifndef DRIVE_ITEM_HPP
#define DRIVE_ITEM_HPP
...
class DriveItem : public AeraGraphicsItem
{
public:
  DriveItem(
...
private:
   ...
   * from driveInject_->object_. Also set valueHtml_ to the HTML source code for the value.
   */
